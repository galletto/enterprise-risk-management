//
//  AGCStoryBoardLinkViewController.m
...
@implementation AGCStoryBoardLinkViewController
...
- (NSString *)verticalConstraintString {
    ...
    if ([self.scene conformsToProtocol:@protocol(AGCStoryboardLinkSource)]) {
        id<AGCStoryboardLinkSource> source = (id<AGCStoryboardLinkSource>)self.scene;
